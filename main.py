...
iface = gr.Interface(fn=create_study_plan, inputs=["file", "file"], outputs="text",
                     title="Generate Study Plan from Two PDFs",
                     description="Upload two PDFs - one for the academic calendar and one for the syllabus - and get a study plan generated.",
